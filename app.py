...
if submit:
    ...
    try:
        ...
        if resp.ok:
            st.success("✅ **Form submitted successfully!** We'll review your application and be in touch soon.")
            st.balloons()
        else:
            st.error("❌ There was an issue submitting your form. Please try again or contact support.")
